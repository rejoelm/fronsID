  ...
  return (
    <section ref={sectionRef} className="py-20 sm:py-28 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="comparison-table overflow-hidden rounded-2xl border border-navy/10 shadow-sm">
          {/* Header */}
          ...
          {comparisons.map((row, i) => (
            <div
              ...
              } border-t border-navy/5`}
            >
              <div className="px-5 py-3.5 text-sm font-medium text-navy">
                {row.feature}
              </div>
              <div className="px-5 py-3.5 text-sm text-navy/40 text-center border-l border-navy/5 flex items-center justify-center gap-1.5">
                <X className="w-3.5 h-3.5 text-red-400 flex-shrink-0 hidden sm:block" />
                <span>{row.traditional}</span>
              </div>
              <div className="px-5 py-3.5 text-sm text-navy font-medium text-center border-l border-navy/5 flex items-center justify-center gap-1.5">
